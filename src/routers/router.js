Router = Backbone.Router.extend({
	...
	home: function() {
		...
		var view = new IssueListView({ collection: collection, parentSelector: '#primary-view-container' });
		this.viewManager.showView(view);
	},

	// used to pass a query string to api endpoint: e.g., when a user sets page > 1
	page: function(query) {
		var collection = new IssueCollection();
	...
	details: function(number) {
		...
		var view = new DetailedIssueView({ model: model });
		this.viewManager.showView(view);
	},
